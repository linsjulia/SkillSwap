...
import { View, Text, Image, TouchableOpacity, StyleSheet, ScrollView, Pressable, Linking } from 'react-native';
...
export default function ProfileScreen() {
  ...
  const handleButtonPress = () => {
    if (UserProfile?.website) {
      Linking.openURL(UserProfile.website); // Abre o link no navegador
    } else {
