  ...
  try {
    ...
    if (userTypeDoc.exists()) {
      ...
      if (!data.bannerImageUrl) {
        ...
        await updateDoc(userTypeDocRef, { bannerImageUrl: downloadURL });
        console.log("Campo 'bannerImageUrl' criado e foto de perfil atualizada com sucesso!");
      } else {
      ...
      await setDoc(userTypeDocRef, { bannerImageUrl: downloadURL });
